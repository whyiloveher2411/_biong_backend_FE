...
function ProductVariable({ product, handleChangeSetType, onReview, handleClickSave }: {
    product: InventoryItem,
    index: number,
    handleChangeSetType: (type: "add" | "set") => void,
