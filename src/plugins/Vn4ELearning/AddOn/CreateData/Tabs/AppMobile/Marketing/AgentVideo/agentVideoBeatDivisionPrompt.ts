...
export function buildBeatDivisionPrompt(context: ImportHtmlContextPayload): string {
    ...
    if (isGithubTop) {
        ...
        return [
            ...
            '- Mỗi section bắt buộc `visual_description`: follow **Visual description — creative summary** above; English; **prefer 20–120 words**, hard allow **5–150** (≤1200 chars).',
    ...
    return [
        ...
        '- Top-level bắt buộc `schema_version: 2`',
        '- `visual_description`: follow **Visual description — creative direction** above; English; **prefer 20–120 words**, hard allow **5–150** (≤1200 chars)',
