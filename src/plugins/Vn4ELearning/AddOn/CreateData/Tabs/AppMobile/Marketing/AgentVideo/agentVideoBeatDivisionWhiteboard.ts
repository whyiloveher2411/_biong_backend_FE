...
export const WHITEBOARD_DUAL_LAYER_OUTPUT_RULE =
    ...
    'fully isolated on a TRANSPARENT background — IMAGE 1 MUST be delivered as a real PNG file ' +
    'with a working alpha channel (RGBA). A JPG/JPEG, or a PNG whose background is filled with ' +
    'white, off-white, cream, grey or any other opaque colour, is an INVALID IMAGE 1 — ' +
    'regenerate it as a true transparent PNG instead of flattening the background. ' +
    'The area between and around the clusters must be 100% fully transparent alpha, ' +
