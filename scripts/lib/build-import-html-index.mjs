...
${sfxHook}${beatHosts}
    ...
    <div id="beat-progress-host" class="clip beat-progress-host" data-start="0" data-duration="${t}" data-track-index="31" style="position:absolute;top:0;left:0;width:1080px;height:4px;z-index:8990;pointer-events:none;"><div class="beat-progress-track" style="position:absolute;inset:0;background:transparent;overflow:hidden;"><div class="beat-progress-fill" style="width:100%;height:100%;background:linear-gradient(90deg,#ffd86b 0%,#ffb347 30%,#ff8f3f 60%,#ff5a36 85%,#ff3b1f 100%);box-shadow:0 0 8px rgba(255,140,64,0.45),0 0 18px rgba(255,90,54,0.30);border-radius:0 2px 2px 0;clip-path:inset(0 100% 0 0);"></div></div></div>
