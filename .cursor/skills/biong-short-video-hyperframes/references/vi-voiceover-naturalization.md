...
- **Cấm** liệt kê bullet trong một hơi thở — chuyển bullet thành **chuỗi But/Therefore**, không phải câu độc lập.
- **Cấm** từ nối liệt kê: *Một là, Hai là, Đầu tiên, Tiếp theo, Ngoài ra, Đồng thời, Bên cạnh đó, Thứ hai là* — xem [narrative-flow-vi.md](narrative-flow-vi.md) §3.
...
| Storytelling | Góc nhìn reviewer TikTok / người dùng — không brochure |
...
| `/viral-audio-script` | §1 + §3 pacing + §4 punctuation + §6 expand chain + expressive tags |
| `/humanize-audio-script` | §2 từ đệm + §1 bảng thay thế + §6 giữ But/Therefore (giữ tag) |
| `/audit-audio-script` | QA cổng cuối — chẩn đoán + sửa; pass bắt buộc (§6 + audit-audio-script.md) |
