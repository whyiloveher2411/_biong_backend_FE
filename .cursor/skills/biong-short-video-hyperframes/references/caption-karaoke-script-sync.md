...
1. **Đọc script** — `get_context.audio_script` → lưu `assets/audio-script.txt`; strip markers `[BGM: ...]`, `[Dừng Ns]`, `[SFX: ...]`, **và thẻ OmniVoice** `[laughter]`, `[sigh]`, `[gasp]` (caption không hiển thị emotion tags).
