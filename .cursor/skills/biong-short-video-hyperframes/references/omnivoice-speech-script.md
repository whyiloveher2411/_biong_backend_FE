...
Engine: Python FastAPI local (`./omnivoice-tts.sh start`) — **không** hiểu SSML XML.
...
4. **Tốc độ đọc** — server dùng `OMNIVOICE_SHORT_VIDEO_SPEED=1.15` (mặc định) cho tiếng Việt viral.
