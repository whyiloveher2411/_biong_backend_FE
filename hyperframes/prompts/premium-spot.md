You are art-directing a 10-second premium product spot — the cinematic
...
- **A four-beat arc inside 10 seconds.**
  - **0.0–2.0s · Anticipation.** A single element fades in or rises into a
    composition that's mostly empty. The viewer leans forward.
  - **2.0–6.0s · Hero.** The product, claim, or moment resolves and breathes.
    This is the longest beat — give it room.
  - **6.0–8.0s · Tagline.** One short line lands beneath / beside the hero.
    Set quietly, never larger than the hero.
  - **8.0–10.0s · Wordmark hold.** The brand mark resolves and sits still.
...
- **Held resolved end frame.** The last 1.5–2.0s are still — only the
...
- Ambient parallax: a single ghost element drifts 1–2% across the frame over
  10 seconds. Anchors the eye without distracting it.
- Wordmark emerges via vertical-rise mask (translateY(0.6em → 0) with mask
  fade-in) around 8s, completes by 9s, holds.
